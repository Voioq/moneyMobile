  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `categories` (`id`,`type`,`category`) VALUES (nullif(?, 0),?,?)";
      }
  ...
  public List<Category> getAllCategories() {
    ...
    try {
      ...
      while (_cursor.moveToNext()) {
        ...
        _item = new Category(_tmpType,_tmpCategory);
        final int _tmpId;
  ...
  public Category getCategoryById(final int categoryId) {
    ...
    try {
      ...
      if (_cursor.moveToFirst()) {
        ...
        _result = new Category(_tmpType,_tmpCategory);
        final int _tmpId;
        _tmpId = _cursor.getInt(_cursorIndexOfId);
